...
def get_sling_cut_load(width_mm):
    sling_table = {50: 10, 75: 15, 100: 20, 125: 25, 150: 30}
...
def get_shackle_wll(size_inch):
    shackle_table = {0.5: 2.0, 0.625: 3.25, 0.75: 4.75, 1.0: 8.5}
...
sling_width = st.selectbox("슬링벨트 폭 (mm)", [50, 75, 100, 125, 150])
...
st.subheader("🟥 샤클 조건")
shackle_size = st.selectbox("샤클 규격 (inch)", [0.5, 0.625, 0.75, 1.0])
...
st.subheader("🟨 크레인 조건")
crane_rated = st.number_input("정격하중 (ton)", min_value=0.1, value=7.9, step=0.1)
